...
<form method="post" action="<%=basePath %>/sys/core/group/create" class="required-validate pageForm" onsubmit="return validateCallback(this, dialogAjaxDone);">
	<input type="hidden" name="parent.id" value="${parentGroup.id }"/>
