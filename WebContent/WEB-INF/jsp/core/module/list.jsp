...
<form id="pagerForm" onsubmit="return divSearch(this, 'jbsxBox2module');" action="<%=basePath %>/sys/core/module/list/${parentModule.id}" method="post">
...
<form method="post" action="<%=basePath %>/sys/core/module/list/${parentModule.id}" onsubmit="return divSearch(this, 'jbsxBox2module');">
...
<div class="pageContent">
	...
	<div class="panelBar">
		...
		<shiro:hasPermission name="Module:save">
			<li><a class="add" target="dialog" width="550" height="350" mask="true" href="<%=basePath %>/sys/core/module/create" ><span>添加</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="Module:edit">
			<li><a class="edit" target="dialog" width="550" height="350" mask="true" href="<%=basePath %>/sys/core/module/update/{slt_uid}" ><span>编辑</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="Module:delete">
			<li><a class="delete" target="ajaxTodo" href="<%=basePath %>/sys/core/module/delete/{slt_uid}" title="确认要删除该模块?"><span>删除</span></a></li>
		</shiro:hasPermission>
		</ul>
	</div>
